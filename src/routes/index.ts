...
import { latestMovies, movieDetails, popularMovies, recentReleaseMovies, topRatedMovies } from '../controllers/movie';
import { latestSeries, popularSeries, recentReleaseSeries, seriesDetails, topRatedSeries } from '../controllers/series';
